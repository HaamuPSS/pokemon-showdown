export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	raticate: {
		...
		evoLevel: 20,
		eggGroups: ["Field"],
		otherFormes: ["Raticate-Mega", "Raticate-Alola", "Raticate-Alola-Totem","Raticate-Alola-Mega"],
		formeOrder: ["Raticate", "Raticate-Mega", "Raticate-Alola", "Raticate-Alola-Totem", "Raticate-Alola-Mega"],
	},
	raticatemega: {
		num: 20,
		name: "Raticate-Mega",
