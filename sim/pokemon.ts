...
export class Pokemon {
	...
	*/
	...
	isGrounded(negateImmunity = false) {
		...
		if (this.hasAbility('levitate') && !this.battle.suppressingAbility()) || (this.hasAbility('shootingstar') && !this.battle.suppressingAbility()) return null;
	...
	runImmunity(type: string, message?: string | boolean) {
		...
		if (notImmune === null) {
			this.battle.add('-immune', this, '[from] ability: Levitate/Shooting Star');
		} else {
			this.battle.add('-immune', this);
		}
		return false;
